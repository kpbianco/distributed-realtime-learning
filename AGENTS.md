# Repository instructions — Distributed Real-Time Systems and Networks

## Product purpose

This repository is the **Distributed Real-Time Systems and Networks** interactive MATLAB learning system, not a collection of disconnected demos. Teach concepts through controlled experiments, notebook-style sections, plots, parameter levers, deliberately broken cases, and concise dialogue.
...
- Product: `distributed-realtime-learning`; delivery profile: `product-data`.
