# P20 walkthrough: Fail Over to a Redundant Path

## Planned learner sequence

1. Read the guiding question: What inputs, observable effects, and failure modes matter when you fail Over to a Redundant Path?
